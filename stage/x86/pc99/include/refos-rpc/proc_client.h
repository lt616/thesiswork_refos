...
/*! @brief Create a new sync endpoint.
 ...
 seL4_CPtr proc_new_endpoint_internal(refos_err_t* _errno);
...
/*! @brief Create a new asynchronous endpoint.
   ...
   @param errno Variable to store error code in.
   @return Recieved cap if success, 0 otherwise. */
 seL4_CPtr proc_new_async_endpoint_internal(refos_err_t* _errno);
...
/*! @brief Create a new memory window segment.
   ...
   (Gives ownership) */
 seL4_CPtr proc_create_mem_window_internal(uint32_t vaddr,uint32_t size,uint32_t permissions,uint32_t flags,refos_err_t* _errno);
...
/*! @brief Get the anonymous dataspace mapped at the given window.
 ...
 seL4_CPtr proc_get_mem_window_dspace(seL4_CPtr window,refos_err_t* _errno);
...
/*! @brief Clones a new thread for process.
 ...
 int proc_clone_internal(seL4_Word entryPoint,seL4_Word childStack,int flags,seL4_Word arg,refos_err_t* _errno);
