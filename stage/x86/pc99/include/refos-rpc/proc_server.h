...
void server_benchmark(void *rpc_userptr);
void reply_benchmark(void *rpc_userptr, refos_err_t rpc___ret__);
extern refos_err_t benchmark_handler(void *rpc_userptr) __attribute__((weak));
...
void reply_proc_new_endpoint_internal(void *rpc_userptr, refos_err_t* rpc__errno, seL4_CPtr rpc___ret__);
extern seL4_CPtr proc_new_endpoint_internal_handler(void *rpc_userptr , refos_err_t* rpc__errno) __attribute__((weak));

void server_proc_new_async_endpoint_internal(void *rpc_userptr);
void reply_proc_new_async_endpoint_internal(void *rpc_userptr, refos_err_t* rpc__errno, seL4_CPtr rpc___ret__);
extern seL4_CPtr proc_new_async_endpoint_internal_handler(void *rpc_userptr , refos_err_t* rpc__errno) __attribute__((weak));
...
void reply_proc_create_mem_window_internal(void *rpc_userptr, refos_err_t* rpc__errno, seL4_CPtr rpc___ret__);
extern seL4_CPtr proc_create_mem_window_internal_handler(void *rpc_userptr , uint32_t rpc_vaddr , uint32_t rpc_size , uint32_t rpc_permissions , uint32_t rpc_flags , refos_err_t* rpc__errno) __attribute__((weak));
...
void reply_proc_get_mem_window_dspace(void *rpc_userptr, refos_err_t* rpc__errno, seL4_CPtr rpc___ret__);
extern seL4_CPtr proc_get_mem_window_dspace_handler(void *rpc_userptr , seL4_CPtr rpc_window , refos_err_t* rpc__errno) __attribute__((weak));
...
void reply_proc_clone_internal(void *rpc_userptr, refos_err_t* rpc__errno, int rpc___ret__);
extern int proc_clone_internal_handler(void *rpc_userptr , seL4_Word rpc_entryPoint , seL4_Word rpc_childStack , int rpc_flags , seL4_Word rpc_arg , refos_err_t* rpc__errno) __attribute__((weak));
