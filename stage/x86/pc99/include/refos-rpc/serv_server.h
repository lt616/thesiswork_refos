...
void reply_serv_connect_direct(void *rpc_userptr, int* rpc__errno, seL4_CPtr rpc___ret__);
extern seL4_CPtr serv_connect_direct_handler(void *rpc_userptr , seL4_CPtr rpc_liveness , int* rpc__errno) __attribute__((weak));
